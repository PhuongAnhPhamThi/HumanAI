...
from Roles.Editor import track_editor
...
class Autor(Role):
    ...
    async def _think(self) -> bool:
        ...
        if last_memory[0].role == "Editor" and self.rc.memory.get_by_action(konzeptErstellen)[0].content != "" and \
            ...
            return True
                ...
                and track_editor < 2 and "sieht gut aus" not in last_memory[0].content and "Sieht gut aus" not in last_memory[0].content:
    ...
    async def _act(self) -> Message:
        ...
        if isinstance(todo, textErstellen):
            ...
            rslt = await todo.run(context=context, thema=thema)
