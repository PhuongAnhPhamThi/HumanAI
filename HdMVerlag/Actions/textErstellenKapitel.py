...
class textErstellenKapitel(Action):
    ...
    # Deine Aufgabe besteht darin, den Teil {teilnummer} des Kapitels {kapitelnummer} zu schreiben. Schreib nur den 
    Text. Wiederhole nicht den Titel des Kapitels, den Titel des Teils und die Beschreibung des Teils. Halte dich 
    klar an das Inhaltsverzeichnis und schreibe genau diesen Teil dieses Kapitels, nach dem ich frage. Der Umfang des Teils beträgt nicht mehr als 100 Wörte. Benutze alle beschriebene Charaktere. Der fertige Text ist ein interssante Geschichte mit faszinierendes Geschichtenerzählen und muss Dialog zwischen Charakter erhalten. Nimm die Untersynopsis des im Plan beschriebenen Kapitels als Grundlage (siehe Context 1). Benutze alle benannte Charaktere. Alle Informationen aus der Synopse sollten verwendet werden. Wenn Context 2 nicht leer ist, muss dein Text eine Folge von dem vorherigen Kapitel im Context 2 sein. Ich werde dir 10000 Euro schenken wenn du gutes Text schreiben kannst!
...
"Kapitel Inhalt Teil {teilnummer}": benutze single anführungszeichen für dialog zwischen Charakter
}}
}}
    """
